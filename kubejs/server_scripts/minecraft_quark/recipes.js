...
ServerEvents.recipes(event => {
    ...
    function vanillaWood(material, override) { //Create the recipes for vanilla wood types
        ...
        if(names.wood != '') {
            ...
            event.recipes.gtceu.lathe('foxtech:' + material + '_post_from_' + '_' + names.wood)
                .itemInputs('1x minecraft:' + material + '_' + names.wood)
                .itemOutputs('2x minecraft:' + material + '_post')
                .duration(8*20)
                .EUt(7)
                .circuit(3)
    ...
    function quarkWood(material, override) {
        ...
        1)  Log -> 6 Planks + 2 Wood Dust
        2)  Log -> 6 V.Planks + 2 Wood Dust */
        cutter('foxtech:' + material + '_planks', ['1x quark:'+ material + '_' + names.log], ['6x quark:' + material + '_planks', '2x gtceu:wood_dust'], 200, 4, 1)
        cutter('foxtech:vertical_' + material + '_planks', ['1x quark:'+ material + '_' + names.log], ['6x quark:vertical_' + material + '_planks', '2x gtceu:wood_dust'], 200, 4, 2)
        ...
        event.recipes.gtceu.lathe('foxtech:stripped_' + material + '_' + names.log) 
            .itemInputs('1x quark:' + material + '_' + names.log)
            .itemOutputs('1x quark:stripped_' + material + '_' + names.log, '1x gtceu:wood_dust')
            .duration(8*20)
            .EUt(7)
            .circuit(1) 
        ...
        /* LOG PACKING RECIPES
            4 Log -> 3 Wood */
        $.modern_industrialization.packer('foxtech:pack_' + material + '_' + names.log + 's', ['4x quark:' + material + '_' + names.log], [], ['3x minecraft:' + material + '_' + names.wood], [], 5*20, 2)
